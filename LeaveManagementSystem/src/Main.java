...
public class Main {
    public static void main(String[] args) throws ParseException {
        ...
        Employee techLead = new TechLead("John", "Doe", "john.doe@company.com");
        Employee projectManager = new ProjectManager("Jane", "Doe", "jane.doe@company.com");
        Employee director = new Director("Bob", "Smith", "bob.smith@company.com");
